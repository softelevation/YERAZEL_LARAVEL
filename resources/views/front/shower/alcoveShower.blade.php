        ...
        <div class="column main scrollable col-md-5 col-lg-5" id="main">
                ...
                <div class="projectDiv d-inline-flex">
                    ...
                    <div class="project-p">
                        <div id="projectshower" class="Rectangle col-md-12 col-sm-12 col-xs-12">
                            <a href="{{ url('shower') }}">Shower</a>
                        </div>
                        <p>$1500</p>
                    </div>
                    <div class="project-p">
                        <div id="projectshower" class="Rectangle col-md-12 col-sm-12 col-xs-12 @if($url_name == 'alcove-shower') active-class @endIf">
            ...
            <div id="DYOBItems" class="DYOBItems">
                ...
                <div class="row">
                    <div class="outer DYOBItems2" id="DYOBItems2">
                        <div id="MovableTitle2" class="DYOBColors Select-your">
                            <p class="titreSection">Select your ALCOVE</p>
                        </div>
                        <div id="Available2" class="row Available-colors-for col-sm-12 mt-0">
                            Alcove - Included in Package
                        </div>
                        <div class="dyob-item-mobile-wrapper clearfix" id="dyob-item-mobile-wrapper2">
                            <div id="dyob-item-wrapper" class="col-lg-3 col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="High Gloss White Acrylic Shower Base (Common: 60-in W x 32-in L; Actual: 59.875-in W x 30.75-in L) RIGHT OR LEFT DRAIN"
                                        class="dyob-item item ImgDYOB ImgDYOB2 wall-pattren1white"
                                        src="assets/images/alcove-img.jpg">
                                    <p class="itemTag">High Gloss White Acrylic Shower Base (Common: 60-in W x 32-in
                                        L; Actual: 59.875-in W x 30.75-in L) RIGHT OR LEFT DRAIN
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="dyob-item-mobile-wrapper clearfix" id="dyob-item-mobile-wrapper2">
                            <div id="dyob-item-wrapper" class="col-lg-3 col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="60X36 White Acrylic Shower Base 36-in W x 60-in L with Left or Right Drain"
                                        class="dyob-item item ImgDYOB ImgDYOB2 wall-pattren1white"
                                        src="assets/images/alcove-upgarde-img.jpg">
                                    <p class="itemTag">60X36
                                        White Acrylic Shower Base 36-in W x 60-in L with Left or Right Drain
                ...
                <div class="row">
                    <div class="outer DYOBItems2" id="DYOBItems2">
                        <div id="MovableTitle2" class="DYOBColors Select-your">
                            <p class="titreSection">Select your Shower Plumber</p>
                        </div>
                        <div id="Available2" class="row Available-colors-for col-sm-12 mt-0">
                ...
                <div class="row">
                    <div class="outer DYOBItems2" id="DYOBItems2">
                        ...
                        <div class="dyob-item-mobile-wrapper clearfix" id="dyob-item-mobile-wrapper2">
                            <div id="dyob-item-wrapper" class="col-lg-3 col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="18-in Stainless Steel Wall Mount (ADA Compliant) Grab Bar"
                        ...
                        <div class="dyob-item-mobile-wrapper clearfix" id="dyob-item-mobile-wrapper2">
                            <div id="dyob-item-wrapper" class="col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="Traditional 18-in Polished Stainless Wall Mount Grab Bar"
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab3white"
                            ...
                            <div id="dyob-item-wrapper" class=" col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="Traditional 18-in Vibrant Brushed Nickel Wall Mount Grab Bar"
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab3brushednickel"
                            ...
                            <div id="dyob-item-wrapper" class=" col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="Traditional 18-in Oil-Rubbed Bronze Wall Mount (ADA Compliant) Grab Bar "
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab3oilrubbedbronze"
                        ...
                        <div class="dyob-item-mobile-wrapper clearfix" id="dyob-item-mobile-wrapper2">
                            <div id="dyob-item-wrapper" class="col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="18-in Chrome Wall Mount (ADA Compliant) Grab Bar "
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab4brushedstainlesssteel"
                            ...
                            <div id="dyob-item-wrapper" class=" col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="18-in Brushed Nickel Wall Mount (ADA Compliant) Grab Bar"
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab4brushednickel"
                            ...
                            <div id="dyob-item-wrapper" class=" col-md-4 col-sm-6 internal dyob-item-wrapper">
                                <div id="112" class="item internal" style="padding-left: 0">
                                    <img alt="4x4 tile pattern" id="112" data-name="18-in Oil Rubbed Bronze Wall Mount (ADA Compliant) Grab Bar"
                                        class="dyob-item item ImgDYOB ImgDYOB6 grab4oilrubbedbronze"
...
roads-latest-l2-2.jpg">
                ...
                <div class="row mt-3 mb-5">
                    <div class="col-lg-2 col-md-1 ButtonFirstNext mb-5">
                        <a href="shower/detail">
                        <button id="nextButtonID" class="btn rect-button">Next</button></a>
                    </div>
                </div>
